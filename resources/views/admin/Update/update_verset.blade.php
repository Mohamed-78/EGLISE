  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/managment/updated/versets/{{ $single->id }}" method="post" enctype="multipart/form-data">
          @csrf
          <div class="row">
            <div class="form-group col-sm-6">
               <label class="control-label">La reference</label>
                <input type="text" class="form-control" name="reference" required="" value="{{ $single->reference }}">
            </div>
            <div class="form-group col-sm-6">
               <label class="control-label">Date de publication</label>
                <input type="date" class="form-control" name="date_ajout" required="" value="{{ $single->date_ajout }}">
            </div>
          </div>
          <div class="row">
            <div class="col-12">
